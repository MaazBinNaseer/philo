...
/* set_sim_stop_flag:
*	Sets the simulation stop flag to true or false. Only the killer
*	checker thread can set this flag. If the simulation stop flag is
...
/* kill checker:
*	The kill checker thread's routine. Checks if a philosopher must
